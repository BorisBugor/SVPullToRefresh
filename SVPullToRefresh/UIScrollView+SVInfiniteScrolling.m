...
- (SVInfiniteScrollingView *)infiniteScrollingView{
  return [self infiniteScrollingViewForPosition: SVInfiniteScrollingPositionBottom];
}

- (void)addInfiniteScrolling:(void (^)(void))actionHandler {
  [self addInfiniteScrollingWithActionHandler:actionHandler forPosition: SVInfiniteScrollingPositionBottom];
}
...
- (void)setState:(SVInfiniteScrollingState)newState {
    ...
    if(hasCustomView) {
        ...
        switch (newState) {
            ...
            if (self.position == SVInfiniteScrollingPositionTop && !_stopsWithoutAnimation) {
